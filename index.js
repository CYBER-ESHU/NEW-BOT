...
console.log('𝙆𝘼𝙑𝙄𝙎𝙃𝘼𝙉 𝙈𝘿 𝘽𝙊𝙏 connected to whatsapp ✅')

let up = `*𝙆𝘼𝙑𝙄𝘿𝙃𝘼𝙉 𝘔𝘋 𝘉𝘖𝘛 𝘊𝘖𝘕𝘕𝘌𝘊𝘛𝘌𝘋*

> _.Menu = Get Bot All Commands_ ⤵

> _.Settings = Customize Bot Settings Work For Owner Only._❄️

𝘉𝘖𝘛 𝘖𝘞𝘕𝘌𝘙 𝘉𝘠 𝘝𝙆𝘼𝙑𝙄𝙎𝙃𝘼𝙉
  𝘿𝙍𝘼𝙆𝙈𝘼𝙏𝙏𝙀𝙍 𝙏𝙀𝘾𝙃

https://wa.me/94776734030`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/ynPjBjN/5777650c1d42f694.jpg` }, caption: up })
